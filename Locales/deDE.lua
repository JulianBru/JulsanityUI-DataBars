...
L["Left-click: open configuration"] = "Linksklick: Konfiguration oeffnen"
L["Drag to reposition."] = "Ziehen zum Verschieben."

-- v1.8 DataTexts (PvP / Talents / Stats / Currency / Sets / Bank)
L["PvP"] = "PvP"
L["Honor"] = "Ehre"
...
L["Loadouts"] = "Loadouts"
L["Active"] = "Aktiv"
L["Secondary Stats"] = "Sekundaerwerte"
L["Critical Strike"] = "Kritischer Trefferwert"
L["Haste"] = "Tempo"
L["Mastery"] = "Meisterschaft"
L["Versatility"] = "Vielseitigkeit"
L["Currency"] = "Waehrung"
L["No currency tracked."] = "Keine Waehrung verfolgt."
L["Equipment Set"] = "Ausruestungsset"
L["No equipment sets."] = "Keine Ausruestungssets."
L["Click to switch set."] = "Klicken zum Wechseln des Sets."
L["Deposited"] = "Eingezahlt"
...
-- Currency by ID
L["Currency ID"] = "Waehrungs-ID"
L["Enter a currency ID to track. Leave empty to use the first currency tracked in your backpack."] = "Waehrungs-ID eingeben. Leer lassen, um die erste im Beutel verfolgte Waehrung zu nutzen."
L["Show Icon"] = "Symbol anzeigen"
L["Value / Max"] = "Wert / Max"
L["Maximum"] = "Maximum"
L["This Week"] = "Diese Woche"
L["Account-wide"] = "Accountweit"
L["Tracked in backpack"] = "Im Beutel verfolgt"
L["Unknown currency ID: %s"] = "Unbekannte Waehrungs-ID: %s"
L["Please enter a number."] = "Bitte eine Zahl eingeben."
